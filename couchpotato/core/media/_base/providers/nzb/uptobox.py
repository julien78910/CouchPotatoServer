                    ...
                    while i > 0 and nb_result - i < 2:
                        ...
                        try:
                            ...
                            if insert == 1 :
                                ...
                                test_age2 = tryInt(html.find_all(class_="corps")[(nb_result - i) % 8].find(text=re.compile('(20[0-9][0-9]|19[0-9][0-9])')))
                                log.error("%s", html.find_all(class_="corps")[(nb_result - i) % 8].find(text=re.compile('(20[0-9][0-9]|19[0-9][0-9])')))
